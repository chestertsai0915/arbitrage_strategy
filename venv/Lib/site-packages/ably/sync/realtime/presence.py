...
from ably.sync.realtime.presencemap import PresenceMap
from ably.sync.types.channelstate import ChannelState, ChannelStateChange
from ably.sync.types.presence import PresenceAction, PresenceMessage
...
class RealtimePresence(EventEmitter):
    ...
    def enter(self, data: Any = None) -> None:
        ...
        return self._enter_or_update_client(None, None, data, PresenceAction.ENTER)
    ...
    def update(self, data: Any = None) -> None:
        ...
        return self._enter_or_update_client(None, None, data, PresenceAction.UPDATE)

    def leave(self, data: Any = None) -> None:
        """
        ...
        return self._leave_client(None, data)

    def enter_client(self, client_id: str, data: Any = None) -> None:
        """
        ...
        """
        return self._enter_or_update_client(None, client_id, data, PresenceAction.ENTER)

    def update_client(self, client_id: str, data: Any = None) -> None:
        """
        ...
        """
        return self._enter_or_update_client(None, client_id, data, PresenceAction.UPDATE)

    def leave_client(self, client_id: str, data: Any = None) -> None:
        """
        ...
        """
        return self._leave_client(client_id, data)

    def _enter_or_update_client(
        self,
        id: str | None,
        client_id: str | None,
        data: Any,
        ...
        if channel.state == ChannelState.ATTACHED:
            # Send immediately
            return self._send_presence([wire_msg])
            ...
            # Queue the message
            return self._queue_presence(wire_msg)
    ...
    def _leave_client(self, client_id: str | None, data: Any = None) -> None:
        """
    ...
    def _send_presence(self, presence_messages: list[dict]) -> None:
        """
        ...
        self.channel.ably.connection.connection_manager.send_protocol_message(protocol_msg)

    def _queue_presence(self, wire_msg: dict) -> None:
        """
    ...
    def get(
        ...
        if self.channel.state == ChannelState.ATTACHING:
            ...
            state_change = self.channel._RealtimeChannel__internal_state_emitter.once_async()
    ...
    def _reenter_member(self, msg_id: str | None, client_id: str, data: Any) -> None:
        """
    ...
    def _send_pending_presence(self) -> None:
        """
        ...
        try:
            self._send_presence(presence_array)
